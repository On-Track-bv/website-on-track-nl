import { 
  IconDatabase, IconBuildingBridge, IconCheckupList, IconRepeat, IconSettingsAutomation,
  IconApi, IconShieldCheck, IconMap, IconCode, IconLink
  ...
  data: {
    nl: {
      ...
      consultancy: [
        ...
        { icon: IconCode, title: 'Software integraties', description: 'Wij bouwen koppelingen tussen BIM, GIS, ERP, CDEs en andere systemen. Ook voor validatie en verrijking van data.' },
